 ...
 * @author Roman
 */
@WebServlet(name = "ExportJSONServlet", urlPatterns = {"/export_json"})
public class ExportJSONServlet extends HttpServlet {

    @EJB (beanName="JSONExport")
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {         
            ...
            response.setHeader("Content-Disposition", "attachment;filename=human_resource_management_data.json");

            OutputStream os = response.getOutputStream();
            os.write(jsonExport.exportJSON().getBytes());
            os.flush();
            os.close();
